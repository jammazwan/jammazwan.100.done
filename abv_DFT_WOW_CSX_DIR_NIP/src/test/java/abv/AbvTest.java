 ...
 * @version $Revision: 85 $
 */
public class AbvTest extends CamelSpringTestSupport {
	...
	public void testOrderOk() throws Exception {
		...
		Leg leg = new Leg();
		leg.setFitness("Strong");
		leg.setLength("long");
		Foot foot = template.requestBody("cxf:bean:entryEndpoint", leg, Foot.class);
		assertEquals("Strong", leg.getFitness());
