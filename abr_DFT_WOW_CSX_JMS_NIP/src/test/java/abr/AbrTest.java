 ...
 * @version $Revision: 85 $
 */
public class AbrTest extends CamelSpringTestSupport {
...
//		 Thread.sleep(200000000);
		Pole pole = new Pole();
		pole.setType("striped");
		pole.setName("long");
		Crank result = template.requestBody("cxf:bean:entryEndpoint", pole, Crank.class);
		assertEquals("long", result.getHandle());
